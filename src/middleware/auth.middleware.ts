...
export interface AuthenticatedRequest extends Request { commanderId?: string }
export async function requireCommander(req: AuthenticatedRequest, res: Response, next: NextFunction) {
