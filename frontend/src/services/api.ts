...
export const incidentsAPI = { simulate:(data:{junction_id:string;severity:number;incident_type:string})=>api.post('/incidents/simulate',data), resolve:(id:string)=>api.post(`/incidents/${id}/resolve`) };
